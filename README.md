...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe9d8119d5cc90015f53c11
...
To start editing your site, you can use the Sanity interface at https://ggcapital-9d811.sanity.studio/.
...
Generated at `2020-12-28T13:06:21.115Z` by Stackbit version `0.3.41`.